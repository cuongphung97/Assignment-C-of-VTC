...
void chuanhoa(char chuoi[])
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        else if (chuoi[i] == ' ' && chuoi[i + 1] > 96 && chuoi[i + 1] < 123)
        {
            chuoi[i + 1] -= 32;
        }
        else if (chuoi[i] != ' ' && chuoi[i + 1] > 64 && chuoi[i + 1] < 91)
        {
            chuoi[i + 1] += 32;
        }
        if (chuoi[n - 1] == ' ')
...
int kiemtra(LichThiDau *lich, DoiBong db[], int count)
{
    ...
    for (i = 0; i < count; i++)
    {
        if (strcmp(lich->doi1, db[i].tendoi) == 0)
        {
            dk--;
        }
        else if (strcmp(lich->doi2, db[i].tendoi) == 0)
        {
            dk--;
        }
    }
...
void ThongKe(DoiBong db)
{
    int i, tran;
    printf("| %-7s", db.madoi);
    printf("| %-23s", db.tendoi);
    tran = db.hoa + db.thang + db.thua;
    printf("|  %2d  |  %2d |  %2d |  %2d  |  %2d  |", tran, db.thang, db.hoa, db.thua, db.diem);
    printf("\n");
}
    ...
    do
    {
        ...
        case 1:
            ...
            else
            {
                ...
                for (i = 0; i < *count; i++)
                {
                    printf("| %-8s| %-23s| %-19s|\n", db[i].madoi, db[i].tendoi, db[i].tenhlv);
                }
                printf("+-------------------------------------------------------+\n");
            }
            ...
            else
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        if (dkid)
                        {
                            printf("Ma doi khong ton tai! Moi nhap lai!\n");
                        }
                    } while (dkid);
        ...
        case 3:
            ...
            do
            {
                do
                {
                    ...
                    for (i = 0; i < *count; i++)
                    {
                        if (strcmp(db[*count].madoi, db[i].madoi) == 0)
                        {
                            dkid = 1;
    ...
    else
    {
        ...
        do
        {
            ...
            do
            {
                ...
                if (dklich)
                {
                    printf("Tran dau khong ton tai! Moi nhap lai!\n");
                }
            } while (dklich);
            printf("\nBan co muon tiep tuc?(Y/N) ");
            fflush(stdin);
...
int main()
{
    ...
    if (team != NULL)
    {
        ...
        if (count > 0)
        {
            fread(db, sizeof(DoiBong), count, team);
        }
        else
            count = 0;
        fclose(team);
    ...
    if (schedule != NULL)
    {
        ...
        if (count2 > 0)
        {
            fread(lich, sizeof(LichThiDau), count2, schedule);
        }
        else
            count2 = 0;
        fclose(schedule);
